...
if ( ! function_exists( 'u8979_enqueue_scripts' ) ) :
    ...
    wp_register_script( 'inline-script-2', '', [], '1.0.1', true );
    ...
    wp_enqueue_script( 'u8979-allefb', get_template_directory_uri() . '/build/js/all-e15fb61743.js', [], '1.0.1', true);

    wp_deregister_script( 'u8979-bundle' );
    wp_enqueue_script( 'u8979-bundle', get_template_directory_uri() . '/iframe-resizer-build/bundle.js', [], '1.0.1', true);

    /* Pinegrow generated Enqueue Scripts End */

        /* Pinegrow generated Enqueue Styles Begin */

    wp_deregister_style( 'u8979-theme' );
    wp_enqueue_style( 'u8979-theme', get_template_directory_uri() . '/css/theme.css', [], '1.0.1', 'all');

    wp_deregister_style( 'u8979-stylebeefbd' );
    wp_enqueue_style( 'u8979-stylebeefbd', get_template_directory_uri() . '/build/css/style-b9eef548bd.css', [], '1.0.1', 'all');

    wp_deregister_style( 'u8979-style' );
    wp_enqueue_style( 'u8979-style', get_bloginfo('stylesheet_url'), [], '1.0.1', 'all');
